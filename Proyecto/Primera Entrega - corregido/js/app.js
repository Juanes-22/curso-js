...
class Perfil {
    constructor(nombre, apellido, sexo, fechaNacimiento, email, altura, peso, ubicacion, nivel) {
        this.nombre = nombre;
...
const usuario1 = new Usuario("bob123", "password");
...
function registro() {
    ...
    perfil.email = prompt("Ingresa un email:");
    perfil.nombre = prompt("¿Cuál es tu nombre?");
    perfil.sexo = prompt("¿Cuál es tu sexo?");
    perfil.ubicacion = prompt("¿En qué país vives?");
    ...
    Ubicación: ${usuario.perfil.ubicacion}
...
function seleccionarRutina() {
    ...
    const rutinaUsuario = usuarioLogin.perfil.rutinas.find((rutina) => rutina.nombre === nombre);
    if (rutinaUsuario) {
...
function mostrarRutinasDisponibles() {
    ...
    for (const rutina of usuarioLogin.perfil.rutinas) {
        salida += `${rutina.mostrarRutina()}`;
    }
...
function entrenar(rutina) {
    ...
    // agrega sesión
    usuarioLogin.perfil.agregarSesion(sesion);
}
...
function menuEdicionPerfil() {
    ...
    while (opcion != 10) {
        opcion = Number(
            prompt(`Menú Edición Perfil:\n${usuarioLogin.perfil.mostrarPerfil()}\nElije dato a editar:
        [1] Nombre
        [2] Apellido
        [3] Sexo
        [4] Edad
        ...
        switch (opcion) {
            case 1:
                usuarioLogin.perfil.nombre = prompt("Ingresa nombre:");
                break;
            case 2:
                usuarioLogin.perfil.apellido = prompt("Ingresa apellido:");
                break;
            case 3:
                usuarioLogin.perfil.sexo = prompt("Ingresa sexo:");
                break;
            case 4:
                usuarioLogin.perfil.edad = prompt("Ingresa edad:");
                break;
            case 5:
                usuarioLogin.perfil.email = prompt("Ingresa email:");
                break;
            case 6:
                usuarioLogin.perfil.altura = prompt("Ingresa altura (cm):");
                break;
            case 7:
                usuarioLogin.perfil.peso = prompt("Ingresa peso (kg):");
                break;
            case 8:
                usuarioLogin.perfil.ubicacion = prompt("Ingresa tu país:");
                break;
            case 9:
                usuarioLogin.perfil.nivel = prompt("Ingresa tu nivel (Principiante, Intermedio, Avanzado):");
                break;
            case 10:
                alert("Saliste...");
                menuPerfil();
...
function mostrarHistoricoPerfil() {
    alert(usuarioLogin.perfil.mostrarSesiones());

    console.log("Histórico sesiones:\n");
    console.table(usuarioLogin.perfil.mostrarSesiones());
}

function mostrarRutinasPerfil() {
    alert(usuarioLogin.perfil.mostrarRutinas());

    console.log("Rutinas creadas:\n");
    console.table(usuarioLogin.perfil.mostrarRutinas());
}
...
function crearRutina() {
    ...
    if (misEjercicios.length > 0) {
        ...
        usuarioLogin.perfil.agregarRutina(miRutina);
    } else {
